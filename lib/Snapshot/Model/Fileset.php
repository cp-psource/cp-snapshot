...
abstract class Snapshot_Model_Fileset {
	...
	public function get_root () {
		...
		return untrailingslashit(wp_normalize_path(
	...
	public static function get_excluded_paths () {
		$config = PSOURCESnapshot::instance()->config_data['config'];
		...
		$exclusion[] = PSOURCESnapshot::instance()->get_setting('backupBaseFolderFull');
