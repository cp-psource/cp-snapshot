...
<section class="wpmud-box wpsd-widget-amazon">
	...
	<div class="wpmud-box-title has-typecon has-button">
		...
		<h3><?php _e( 'Amazon S3', 'cp-snapshot' ); ?></h3>

		<a class="button button-small button-outline" href="<?php echo add_query_arg( array( 'snapshot-action' => 'add' , 'type' => 'aws' ), PSOURCESnapshot::instance()->snapshot_get_pagehook_url('snapshots-newui-destinations') ); ?>" class="button button-outline"><?php _e( 'Add Destination', 'cp-snapshot' ); ?></a>
