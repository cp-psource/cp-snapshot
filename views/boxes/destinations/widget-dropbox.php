...
<section class="wpmud-box wpsd-widget-dropbox">
	...
	<div class="wpmud-box-title has-typecon has-button">
		...
		<h3><?php _e( 'Dropbox', 'cp-snapshot' ); ?></h3>

		<a class="button button-small button-outline" href="<?php echo add_query_arg( array( 'snapshot-action' => 'add' , 'type' => 'dropbox' ), PSOURCESnapshot::instance()->snapshot_get_pagehook_url('snapshots-newui-destinations') ); ?>" class="button button-outline"><?php _e( 'Add Destination', 'cp-snapshot' ); ?></a>
