				...
				<div class="wpmud-box-content">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<p><?php _e('This is your Snapshot API key. If you have any issues connecting to WPMU DEV’s cloud servers, just reset your key. Don’t worry, resetting your key won’t affect your backups.', SNAPSHOT_I18N_DOMAIN); ?></p>

							<?php else : ?>

								<div class="wps-snapshot-popin-content wps-snapshot-popin-content-step-1">
									<p><?php _e('To enable Managed Backups and your 10GB storage allowance on our WPMU DEV cloud servers, you need to add your Snapshot key.', SNAPSHOT_I18N_DOMAIN); ?></p>
								...
								<div class="wps-snapshot-popin-content wps-snapshot-popin-content-step-3 hidden">
									<div class="wps-snapshot-error wpmud-box-gray">
										<p><?php printf(__('We couldn’t verify your Snapshot key. Try entering it again, or reset it for this website in <a target="_blank" href="%s">The Hub</a> over at WPMU DEV.', SNAPSHOT_I18N_DOMAIN ), 'https://premium.psource.org/hub/' );?></p>
									</div>
								</div>
