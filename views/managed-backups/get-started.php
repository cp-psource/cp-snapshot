			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<?php if ( empty( $is_dashboard_active ) && empty( $is_dashboard_installed ) ) : ?>
						...
						<p>
							<a href="https://premium.psource.org/project/wpmu-dev-dashboard/" target="_blank" class="button button-blue">
					...
					<?php elseif ( ! $has_dashboard_key ) : ?>
						...
						<p>
							<a href="<?php echo esc_url( network_admin_url( 'admin.php?page=psource' ) ); ?>" class="button button-blue">
