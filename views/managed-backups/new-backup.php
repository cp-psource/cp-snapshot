...
<form id="managed-backup-update" method="post" action="<?php echo add_query_arg( 'tab', 'settings', PSOURCESnapshot::instance()->snapshot_get_pagehook_url( 'snapshots-newui-managed-backups' ) ); ?>">
								...
								<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
									...
									<div class="wpmud-box-mask">
										...
										<label class="label-title"><?php
											...
											printf(
												__( "Managed backups can only be stored on PSOURCE's cloud servers. You have <strong>%s</strong> of your %s storage remaining.", SNAPSHOT_I18N_DOMAIN ),
										...
										<div class="wpmud-box-gray">
											...
											<div class="radio-destination">
												...
												<div class="wps-input--item">
													...
													<label for="snap-cloud"><span><?php _e( 'PSOURCE Cloud', SNAPSHOT_I18N_DOMAIN ); ?></span><i class="wps-typecon cloud"></i></label>
