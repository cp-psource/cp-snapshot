					...
					<div class="wpmud-box-content">
						...
						<div class="row">
							...
							<div class="col-xs-12">
								...
								<form class="row-box" id="managed-backup-update" method="post" action="<?php echo PSOURCESnapshot::instance()->snapshot_get_pagehook_url( 'snapshots-newui-managed-backups' ); ?>&tab=settings">
