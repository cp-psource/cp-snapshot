								...
								<div class="my-snapshots-content">
									...
									<table cellpadding="0" cellspacing="0">
										...
										<?php foreach ( $per_page_snapshots as $key => $snapshot ) :
											...
											$snapshot_locker = new Snapshot_Helper_Locker( PSOURCESnapshot::instance()->get_setting( 'backupLockFolderFull' ), $snapshot['timestamp'] );
											...
											if ( $snapshot['destination'] == 'local' ) {
												...
												if ( isset( PSOURCESnapshot::instance()->config_data['destinations'][ $destination_slug ] ) ) {

													$destination_type = PSOURCESnapshot::instance()->config_data['destinations'][ $destination_slug ]['type'];
											...
											if ( $snapshot['destination'] == 'local' ) {
												...
												if ( ( isset( PSOURCESnapshot::instance()->config_data['destinations'][ $destination_slug ]['name'] ) ) && ( strlen( PSOURCESnapshot::instance()->config_data['destinations'][ $destination_slug ]['name'] ) ) ) {
											...
											<tr>
												...
												<td class="msc-name">
													...
													<p>
														<a href="<?php echo PSOURCESnapshot::instance()->snapshot_get_pagehook_url( 'snapshots-newui-snapshots' ); ?>&amp;snapshot-action=view&amp;item=<?php echo $snapshot['timestamp']; ?>"><?php echo stripslashes( $snapshot['name'] ); ?></a>
